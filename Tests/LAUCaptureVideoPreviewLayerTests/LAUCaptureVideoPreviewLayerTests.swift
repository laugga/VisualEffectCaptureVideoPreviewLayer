/*
 ...
 LAUCaptureVideoPreviewLayerTests.swift
...
final class LAUCaptureVideoPreviewLayerTests: XCTestCase {

    private var videoPreviewLayer: LAUCaptureVideoPreviewLayer!
    private var mockInternal: MockLAUCaptureVideoPreviewLayerInternal!

    override func setUp() {
        super.setUp()

        // Create the session video preview layer
        videoPreviewLayer = LAUCaptureVideoPreviewLayer(session: nil)
        videoPreviewLayer.backgroundColor = UIColor.black.cgColor
        videoPreviewLayer.videoGravity = .resizeAspectFill // fill the layer

        // Inject the stand-in for the capture pipeline
        mockInternal = MockLAUCaptureVideoPreviewLayerInternal()
